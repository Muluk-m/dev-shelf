													...
													{commands.map((command, commandIndex) => {
														...
														return (
															<button
																...
																className={cn(
																	"w-full flex items-center gap-3 px-3 py-2 rounded-md text-left transition-all duration-150 overflow-hidden",
															...
															>
																...
																<div className="flex-1 min-w-0">
																	...
																	{command.description && (
																		<div className="text-xs text-muted-foreground max-w-135 truncate">
																			{command.description}
																		</div>
																	)}
																</div>
