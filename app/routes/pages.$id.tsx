...
export default function QRCodeMaker({ params }: Route.ComponentProps) {
  console.log(params);
        ...
        <div className="min-w-96">
          ...
          <CardContent className="flex items-center justify-start mb-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setSize(
                  Math.max(160, Math.min(1024, Number(e.target.value) || 300))
                )
              }
            />
          </CardContent>
          ...
          <CardContent className="flex items-center justify-start mb-4">
            <Label htmlFor="margin" className="min-w-[100px] justify-end mr-4">
              边距
            </Label>
            <Input
              id="margin"
          ...
          <CardContent className="flex items-center justify-start mb-4">
            <Label htmlFor="bgColor" className="min-w-[100px] justify-end mr-4">
              背景色
            </Label>
            <Input
              className="w-[100px]"
          ...
          <CardContent className="flex items-center justify-start mb-4">
            <Label htmlFor="fgColor" className="min-w-[100px] justify-end mr-4">
              前景色
            </Label>
            <Input
              className="w-[100px]"
